        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl">
            <div className="flex items-center justify-between p-5 border-b border-[#E8E4F0]">
              <div>
                <h3 className="font-bold text-[#424040]">Review Submission</h3>
                <p className="text-xs text-[#8A8888]">{submission.user.name} · {submission.assignment.title}</p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              ...
              {submission.aiFeedback && (
                <div className="bg-[#F8F6FF] border border-[#C4B8EE] rounded-lg p-3">
                  <p className="text-xs font-bold text-[#8A70D6] mb-1">🤖 AI Pre-review</p>
                  <p className="text-xs text-[#424040] whitespace-pre-wrap">{submission.aiFeedback}</p>
                </div>
              )}

              <div>
                <label className="block text-sm font-semibold text-[#424040] mb-1.5">Grade (0–100)</label>
              ...
              <div>
                <label className="block text-sm font-semibold text-[#424040] mb-1.5">Written Feedback</label>
